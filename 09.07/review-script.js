...
function onReviewSubmit(){
    ...
    console.log(localStorage.getItem("registrations")); // jutumärkidega kuju
    console.log(JSON.parse(localStorage.getItem("registrations"))); // kuju [{},{},{}]

    var registrationList = JSON.parse(localStorage.getItem("registrations")) || [];

    // pushiiseks vaja json.parse
